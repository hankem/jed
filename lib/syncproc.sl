...
%\description
%  The \sfun{open_filter_process} function may be used to open an interactive
...
%  "output" option of the \sfun{set_process} function.  The process should be
%  closed using the \sfun{close_filter_process} function.
...
%\description
%  The \sfun{close_filter_process} function waits for the specified process
%  to terminate and returns the exit status of the process.  The process must
%  have been previously opened via the \sfun{open_filter_process} function.
