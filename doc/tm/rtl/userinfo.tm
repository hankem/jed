...
\description
  The \ifun{get_hostname} function returns the name of the host
...
\description
  The \ifun{get_realname} returns the user's real name.  If the editor
...
\description
  The \ifun{get_username} function returns the username associated with
...
\description
  \ifun{set_hostname} may be used to set set the name of the host that
...
\description
  The \ifun{set_realname} function sets the editor's notion of what the
  user's real name is such that subsequent calls to \ifun{get_realname}
