...
\usage{check_buffers ()}
\description
  The \var{check_buffers} function checks to see whether or not any of the
  disk files that are associated with the editor's buffers have been
  modified since the association was made.  The buffer flags are updated
  accordingly.
...
#v-
  Here, \exmp{(1 shl 4)} has been written as the hexadecimal number
  \exmp{0x10}.
